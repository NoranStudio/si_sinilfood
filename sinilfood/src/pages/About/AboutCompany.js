...
import companyBuildingImg from "../../assets/img/about/company-building.png";
import meetingImg from "../../assets/img/about/meeting.png";
import missionImg from "../../assets/img/about/mission.png";
import signImg from "../../assets/img/about/sign.png";
import { ReactComponent as GreenIcon } from "../../assets/img/about/green.svg";
import { ReactComponent as SocialIcon } from "../../assets/img/about/social.svg";
import { ReactComponent as GroupIcon } from "../../assets/img/about/group.svg";
  ...
  return (
    <div class="about__company">
      <div class="about__company__contents">
        ...
        <div class="about__company__detail">
          <div class="about__company__detail__text">
            <p>
          ...
          <div class="about__company__sign">
            <p>(주)신일푸드 대표이사</p>
            <p>박 영 미</p>
      ...
      <img
        class="about__company__banner"
        src={meetingImg}
        alt="company-banner"
      />
      <div class="about__company__contents">
        <h1>경영이념</h1>
        <div class="about__company__mission">
          <p>Yes!</p>
          <p>
      ...
      <div class="about__company__contents">
        <h1>ESG 경영</h1>
        <div class="about__company__esg-title">
          <p>지속가능경영</p>
          <p>ESG 핵심철학</p>
        </div>
        <div class="about__company__cards">
          <div class="about__company__card">
            <GreenIcon />
